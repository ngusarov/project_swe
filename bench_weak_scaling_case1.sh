...
# This script performs weak scaling benchmarks for test_case_id 1.
...
TEST_CASE=1 # Using test case 1 for all weak scaling runs
...
LOCAL_BASE_SIZES=(100 200 300) # Example: 100x100, 200x200, 300x300 cells per process
...
echo "test_case,local_base_size,global_nx,global_ny,procs,run,total_time_seconds,num_iterations,time_per_iteration" > bench_results_weak_scaling/timings_weak_scaling_case1.csv
...
for LOCAL_BASE_SIZE in "${LOCAL_BASE_SIZES[@]}"; do
  ...
  for NPROCS in "${PROCS[@]}"; do
    ...
    for ((i = 1; i <= REPEAT; i++)); do
      ...
      TEMP_OUTPUT_FILE="tmp_output_weak_case1_${LOCAL_BASE_SIZE}_${NPROCS}_${i}_$$_${SLURM_JOB_ID}.txt"
      ...
      echo "$TEST_CASE,$LOCAL_BASE_SIZE,$GLOBAL_NX,$GLOBAL_NY,$NPROCS,$i,$TOTAL_TIME,$NUM_ITERATIONS,$TIME_PER_ITERATION" >> bench_results_weak_scaling/timings_weak_scaling_case1.csv
...
echo "Weak scaling for Test Case $TEST_CASE completed. Results in bench_results_weak_scaling/timings_weak_scaling_case1.csv"
